    ...
    <div className="sticky top-0 z-10 flex flex-row items-center justify-between h-14 px-4 md:px-5 bg-white dark:bg-[#0F0F0F]">
      ...
      <div className="group flex items-center">
          <div className="flex h-8 md:h-10 md:ml-10 md:pl-5 border border-[#303030] rounded-l-3xl group-focus-within:border-blue-500 md:group-focus-within:ml-5 md:group-focus-within:pl-0">
            ...
            <input 
            type="text" 
            className=' bg-transparent outline-none text-white pr-5 pl-5 md:pl-0 w-44 md:group-focus-within:pl-0 md:w-64 lg:w-[500px] placeholder-[#7E7E7E]'
            placeholder='Search'
        ...
        <div className="felx items-center">
          <div className="hidden md:flex">
            ...
            <div className="flex h-8 overflow-hidden rounded-full md:ml-4">
              <img className='' src="https://xsgames.co/randomusers/avatar.php?g=male" alt="profile_pic" />
            </div>
          </div>
        </div>
    </div>
